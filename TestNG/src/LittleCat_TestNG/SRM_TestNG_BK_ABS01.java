...
public class SRM_TestNG_BK_ABS01 extends LC_Abstracts {
...
//		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void Select_SWPM_Test () {  // Select_SWPM_Test
		...
		System.out.println("Select_Airplane_Test calls test");
		this.Select_Airplane("30830");
		System.out.println("***************************Calling open SWPM ******************** test");
		// this.Select_SRM_Method();
	...
	public void Searching_Test () {  // Select_SRM_Test
		System.out.println("Select_Airplane_Test STARTS");	 //System.out.println("Select_Airplane_Test calls EULA");
		this.doLogin();
		System.out.println("Select_Airplane_Test calls test");
		this.Select_Airplane("30830");
		...
		this.Searching_Method("door");  //span[@id='span_Revision Type_AR']   //this.Searching_Method("AR");
		// Chem-Milled
	...
	public void search_Result_Type () {  // AR or OEM  
		System.out.println("Select_Airplane_Test STARTS");	 //System.out.println("Select_Airplane_Test calls EULA");
		this.doLogin();
		System.out.println("Select_Airplane_Test calls test");
		this.Select_Airplane("30830");
