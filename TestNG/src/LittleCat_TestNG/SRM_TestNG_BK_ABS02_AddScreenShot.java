...
public class SRM_TestNG_BK_ABS02_AddScreenShot extends LC_Abstracts {
...
//		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void Searching_Test () throws IOException {  // Select_SRM_Test
		...
		FileUtils.copyFile(screenshotFile, new File(PATH_SCREENSHOTS));  // // FileUtils.copyFile(screenshotFile, new File(PATH_SCREENSHOTS + "\\oct_srh.png"));
		// NOT in USE ------ FileUtils.copyFile(screenshotFile, new File("E:\\Eclipse-Data\\workspaces\\Eclipse-inst-win64-Data-Neon\\TestNG\\screenShots\\oct_srh.png"));
		//  NOT in USE ------                  driver.close(); PATH_SCREENSHOTS
		org screenshot    */
	...
	@Test(priority = 8, enabled = true)  // @Ignore
	public void Select_Result_Type_Test() throws IOException {  // AR or OEM  
		...
		waiting (3000);   // DElay to be able to catch screenshot
		TakesScreenshot snapper = (TakesScreenshot)driver; 
		File tempScreenshot = snapper.getScreenshotAs(OutputType.FILE); 
		File myScreenshotDirectory = new File("E:\\Eclipse-Data\\workspaces\\Eclipse-inst-win64-Data-Neon\\TestNG\\screenShots");  // E:\Eclipse-Data\workspaces\Eclipse-inst-win64-Data-Neon\TestNG\screenShots
		String newImageFile = "LC_AR_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + ".png";
		File myScreenshot = new File (myScreenshotDirectory, newImageFile);
		FileUtils.moveFile(tempScreenshot, myScreenshot);
