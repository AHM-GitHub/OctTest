...
//@Test
public class Chrome_Hub_Server {          // E:\Eclipse-Data\workspaces\Eclipse-inst-win64-Data-Neon\Selenium_313\src\practices
	...
	public void test_before()throws Exception{
		...
		/*   Below is Chrome for RemoteWebdriver			
		...
		caps.setBrowserName("chrome");         //caps.setBrowserName("firefox");
		 caps.setPlatform(Platform.WINDOWS);
		 driver = new RemoteWebDriver(new URL("http://172.16.0.64:5555/wd/hub"),caps);
		 //  Above is Chrome for RemoteWebdriver                  */
		...
		driver = new ChromeDriver();    // driver = new ChromeDriver();  //driver = new FirefoxDriver();
...
//		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void test_two_Simple_Form_Demo(){		
		...
		JOptionPane.showMessageDialog(null, "Chrome_Hub_Server - End of Test 1 of 2");  // Chrome_Node - TC01 Input
		//JOptionPane.showMessageDialog(null, "End of Input Form Test using sendKeys method");  // Chrome_Node - TC01 Input 
	...
	//@Ignore //  FINISHED 
		...
		public void test_Drag_And_Drop(){   
			...
			JOptionPane.showMessageDialog(null, "Chrome_Hub_Server - End of Test 2 of 2");// showMessageDialog(null, "This is even shorter");
			//waiting(3000); 
